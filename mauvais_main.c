...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ULPI_D3_Pin ULPI_D4_Pin ULPI_D2_Pin ULPI_D5_Pin
                           ULPI_D1_Pin ULPI_D6_Pin */
  GPIO_InitStruct.Pin = ULPI_D3_Pin|ULPI_D4_Pin|ULPI_D2_Pin|ULPI_D5_Pin
                          |ULPI_D1_Pin|ULPI_D6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
